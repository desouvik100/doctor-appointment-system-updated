/**
 * Admin Edit Clinic Screen - Update Clinic Details
...
const AdminEditClinicScreen = ({ navigation, route }) => {
  const { clinicId, clinic: initialClinic } = route.params;
  ...
  const fetchClinic = async () => {
    try {
      const data = await adminApi.getClinicById(clinicId);
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await adminApi.updateClinic(clinicId, form);
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Edit Clinic</Text>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          {loading ? (
            ...
            <Text style={styles.submitBtnText}>Update Clinic</Text>
          )}
        </TouchableOpacity>
      </ScrollView>
    </View>
...
export default AdminEditClinicScreen;
