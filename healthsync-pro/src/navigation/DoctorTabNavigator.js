...
import DoctorPrescriptionDetailScreen from '../screens/doctor/DoctorPrescriptionDetailScreen';
...
const DoctorDashboardStack = () => {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="DoctorPrescriptionDetail" component={DoctorPrescriptionDetailScreen} />
