...
<head>
  ...
  <style>
    ...
    .icon-item a { display: inline-block; margin-top: 10px; padding: 8px 16px; background: #0ea5e9; color: white; text-decoration: none; border-radius: 4px; font-size: 12px; }
    .icon-item a:hover { background: #0284c7; }
    .instructions { background: #e0e7ff; padding: 15px; border-radius: 8px; margin-bottom: 20px; }
    .download-all { background: #22c55e; color: white; padding: 12px 24px; border: none; border-radius: 8px; font-size: 16px; cursor: pointer; margin-bottom: 20px; }
    .download-all:hover { background: #16a34a; }
  </style>
</head>
<body>
  <div class="container">
