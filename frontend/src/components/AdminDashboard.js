            ...
            <li className="nav-item">
              ...
              >
                ...
                {pendingReceptionists.length > 0 && (
                  <span className="badge bg-warning text-dark ms-1">{pendingReceptionists.length}</span>
                )}
              </button>
            </li>
          </ul>
        ...
        <div className="card-body">
          {activeTab === "overview" && (
            <div>
              ...
              <p className="text-muted">Welcome to the admin dashboard. Monitor and manage your healthcare system.</p>
                      ...
                      <tr key={user._id}>
                        ...
                        <td>
                          {user.role === 'receptionist' && user.approvalStatus && (
                            <span className={`badge ${
                              user.approvalStatus === 'approved' ? 'bg-success' :
                  ...
                  <tbody>
                    {clinics.map((clinic) => (
                      <tr key={clinic._id}>
                        ...
                        <td>
                          <span className={`badge ${
                            clinic.type === 'hospital' ? 'bg-danger' : 'bg-info'
                          }`}>
                            {clinic.type}
                          </span>
                        </td>
            ...
            <div>
              ...
              <div className="row g-3 mb-4">
                <div className="col-md-3">
                  <div className="card bg-primary text-white">
                    <div className="card-body">
                      <h6 className="card-subtitle mb-2">Total Appointments</h6>
                ...
                <div className="col-md-3">
                  <div className="card bg-success text-white">
                    <div className="card-body">
                      ...
                      <h3 className="mb-0">{appointments.filter(a => a.status === 'completed').length}</h3>
                    </div>
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="card bg-warning text-dark">
                    <div className="card-body">
                      ...
                      <h3 className="mb-0">{appointments.filter(a => a.status === 'pending').length}</h3>
                    </div>
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="card bg-info text-white">
                    <div className="card-body">
                      <h6 className="card-subtitle mb-2">Confirmed</h6>
                      <h3 className="mb-0">{appointments.filter(a => a.status === 'confirmed').length}</h3>
                    </div>
                  </div>
                </div>
              </div>
