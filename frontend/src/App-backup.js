...
function App() {
  ...
  const LandingPage = () => (
    <div className={`min-vh-100 ${darkMode ? 'dark-theme' : 'medical-bg'}`}>
        ...
        <div style={{ padding: '20px', background: 'red', color: 'white', position: 'fixed', top: '10px', left: '10px', zIndex: 9999 }}>
          Landing Page Loaded - Dark Mode: {darkMode ? 'ON' : 'OFF'}
        </div>
      ...
      return (
      <div>
        {/* Test div to check if App is rendering */}
        <div style={{ position: 'fixed', top: '0', left: '0', background: 'blue', color: 'white', padding: '10px', zIndex: 10000 }}>
          App Loaded - Current View: {currentView}
        </div>
