                  ...
                  <div className="row mb-4">
                    <div className="col-md-3 col-sm-6 mb-3">
                      <div className="stats-card text-center">
                        ...
                        <small className="text-muted">Tomorrow 2:30 PM</small>
                      </div>
                    </div>
                    <div className="col-md-3 col-sm-6 mb-3">
                      <div className="stats-card text-center">
                        ...
                        <h6 className="mb-1">My Doctor</h6>
                        <small className="text-muted">Dr. Sarah Johnson</small>
                      </div>
                    </div>
                    <div className="col-md-3 col-sm-6 mb-3">
                      <div className="stats-card text-center">
                        ...
                        <h6 className="mb-1">Health Score</h6>
                        <small className="text-muted">85/100 Good</small>
                      </div>
                    </div>
                    <div className="col-md-3 col-sm-6 mb-3">
                      <div className="stats-card text-center">
                        ...
                        <h6 className="mb-1">Medications</h6>
                        <small className="text-muted">2 Active</small>
                      </div>
                    </div>
                  </div>
